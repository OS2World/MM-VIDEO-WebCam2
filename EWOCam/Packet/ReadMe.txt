EWOCam/2 ReadMe                                                         30 Jul 1998  


EWOCam/2 (ELSA WINNER 2000/Office web Camera for OS/2)
...
EWOCam/2's current development status:
...
If you want to deinstall EWOCam/2, just delete the files. Thats it!


Running EWOCam/2

Set up the ELSA P2VideoIn device with the Multimedia Setup Notebook (source, brightness, etc.)
...
Image size:      Select the destination image size in pixels

Just view video:    If this box is checked, file saving is disabled and the program
                    tries to display the video as fast as possible. Could be helpful for
                    adjusting the video source.
...
Distribution on CD/Shareware collections only with permission, please.

Many thanks to Hartmut Bohn of ELSA AG for supporting this OS/2-project!

If you like this program, an email would be welcome!
...
History:
24 Jun 1998 : Image size now adjustable and bugfixed
30 Jul 1998 : Fix: Program does not terminate after altering the resolution
